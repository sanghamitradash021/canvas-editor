...
var index = "";
const version = "0.0.1-development";
var MaxHeightRatio;
...
function findScrollContainer(element) {
  ...
  while (parent) {
    ...
    const overflowY = style2.getPropertyValue("overflow-y");
...
function convertTextNodeToElement(textNode) {
  ...
  const style2 = window.getComputedStyle(anchorNode);
  if (!value || anchorNode.nodeName === "STYLE")
    return null;
  const element = {
    value,
    color: style2.color,
    bold: Number(style2.fontWeight) > 500,
    italic: style2.fontStyle.includes("italic"),
    size: Math.floor(parseFloat(style2.fontSize))
  };
  if (anchorNode.nodeName === "SUB" || style2.verticalAlign === "sub") {
    element.type = ElementType.SUBSCRIPT;
  } else if (anchorNode.nodeName === "SUP" || style2.verticalAlign === "super") {
    element.type = ElementType.SUPERSCRIPT;
  }
  if (rowFlex !== RowFlex.LEFT) {
    element.rowFlex = rowFlex;
  }
  if (style2.backgroundColor !== "rgba(0, 0, 0, 0)") {
    element.highlight = style2.backgroundColor;
  }
  return element;
}
...
function input(data2, host, options) {
  var _a;
  const isPaste = !!(options == null ? void 0 : options.isPaste);
  const draw = host.getDraw();
  const isReadonly = draw.isReadonly();
  if (isReadonly)
    return;
...
`, ZERO);
  ...
  const inputData = splitText(text).map((value) => {
    ...
    if (hasPending) {
      Object.keys(pendingStyle).forEach((k) => {
        const v = pendingStyle[k];
        if (v === void 0 || v === null || v === "" || v === false) {
          delete newElement[k];
        } else {
          newElement[k] = v;
        }
  ...
  if (~curIndex) {
    rangeManager.setRange(curIndex, curIndex, void 0, void 0, void 0, void 0, void 0, isComposing);
    draw.render({
      curIndex,
...
class RangeManager {
  constructor(draw) {
    ...
    __publicField(this, "pendingStyle");
    this.draw = draw;
    this.options = draw.getOptions();
  ...
  consumePendingStyle() {
    const style2 = this.pendingStyle;
    this.pendingStyle = {};
    return style2;
  }
  getAnchorElementAtCursor() {
  ...
  togglePendingBooleanStyle(key) {
    const anchor = this.getAnchorElementAtCursor();
    const baseVal = !!(anchor == null ? void 0 : anchor[key]);
    const currentEff = this.pendingStyle[key] !== void 0 ? !!this.pendingStyle[key] : baseVal;
  ...
  setPendingStyleValue(key, value) {
    const anchor = this.getAnchorElementAtCursor();
    const baseVal = anchor == null ? void 0 : anchor[key];
  ...
  setRange(startIndex, endIndex, tableId, startTdIndex, endTdIndex, startTrIndex, endTrIndex, preservePendingStyle = false) {
    const rangeChanged = this.range.startIndex !== startIndex || this.range.endIndex !== endIndex;
  ...
  getContentStyles() {
    ...
    const effectiveElement = __spreadValues(__spreadValues({}, curElement), pending);
    const effectiveList = selection ? curElementList : [effectiveElement];
...
class TableParticle {
  ...
  _drawOuterBorderWithBg(payload) {
    ...
    trList.forEach((tr) => {
      tr.tdList.forEach((td, i) => {
        ...
        ctx.strokeStyle = (_a = td.borderBgLeft) != null ? _a : "black";
        ctx.lineWidth = (_b = td.borderWidthLeft) != null ? _b : 1;
    ...
    trList[0].tdList.forEach((td) => {
      ...
      ctx.strokeStyle = (_a = td.borderBgTop) != null ? _a : "black";
      ctx.lineWidth = (_b = td.borderWidthTop) != null ? _b : 1;
  ...
  _drawBorder(ctx, element, startX, startY) {
    ...
    for (let t = 0; t < trList.length; t++) {
      ...
      for (let d = 0; d < tr.tdList.length; d++) {
        ...
        const trNext = (_a = trList[t + 1]) == null ? void 0 : _a.tdList[d];
        ...
        ctx.beginPath();
        ctx.moveTo(x, y);
        ctx.strokeStyle = td.borderBgRight ? td.borderBgRight : (tdNext == null ? void 0 : tdNext.borderBgLeft) ? tdNext == null ? void 0 : tdNext.borderBgLeft : "black";
        ctx.lineWidth = td.borderWidthRight ? td.borderWidthRight : (tdNext == null ? void 0 : tdNext.borderWidthLeft) ? tdNext == null ? void 0 : tdNext.borderWidthLeft : 1;
        ctx.lineTo(x, y + height);
        ctx.stroke();
        ctx.closePath();
        ctx.beginPath();
        ctx.strokeStyle = td.borderBgBottom ? td.borderBgBottom : (trNext == null ? void 0 : trNext.borderBgTop) ? trNext == null ? void 0 : trNext.borderBgTop : "black";
        ctx.lineWidth = td.borderWidthBottom ? td.borderWidthBottom : (trNext == null ? void 0 : trNext.borderWidthTop) ? trNext == null ? void 0 : trNext.borderWidthTop : 1;
...
const _PageBreakParticle = class {
  constructor(draw) {
    __publicField(this, "draw");
    __publicField(this, "options");
    this.draw = draw;
  ...
  render(ctx, element, x, y) {
    const { font, fontSize, displayName, lineDash } = _PageBreakParticle;
...
let PageBreakParticle = _PageBreakParticle;
__publicField(PageBreakParticle, "font", "Yahei");
__publicField(PageBreakParticle, "fontSize", 12);
__publicField(PageBreakParticle, "displayName", "\u5206\u9875\u7B26");
__publicField(PageBreakParticle, "lineDash", [3, 1]);
class Watermark {
  constructor(draw) {
    __publicField(this, "draw");
    __publicField(this, "options");
...
const contextmenu = {
  ...
  table: {
    ...
    tdBgColor: "Cell background color",
    tdBgColorChild: "Select color",
    borderBg: "Cell border color",
    top: "Top",
    bottom: "Bottom",
    left: "Left",
    right: "Right",
...
class I18n {
  ...
  registerLangMap(locale, lang) {
    ...
    this.langMap.set(locale, mergeObject(sourceLang || en, lang));
  }
  setLocale(locale) {
...
class Draw {
  ...
  computeRowList(innerWidth, elementList) {
    ...
    const rowList = [];
    if (elementList.length) {
      const firstParagraphTop = ((_a = elementList[0]) == null ? void 0 : _a.marginTop) ? elementList[0].marginTop * this.options.scale : 0;
      rowList.push({
        width: 0,
        ...
        elementList: [],
        startIndex: 0,
        rowFlex: (_b = elementList == null ? void 0 : elementList[1]) == null ? void 0 : _b.rowFlex
      });
    }
    let listId;
    let listIndex = 0;
    ...
    for (let i = 0; i < elementList.length; i++) {
      ...
      const isImageOrLatex = element.imgDisplay !== ImageDisplay.INLINE && element.type === ElementType.IMAGE || element.type === ElementType.LATEX;
      ...
      const contentHeight = metrics.boundingBoxAscent + metrics.boundingBoxDescent;
      const lineMargin = Math.max(0, (lineHeight - contentHeight) / 2);
      const ascent = isImageOrLatex ? metrics.height + rowMargin : metrics.boundingBoxAscent + lineMargin;
      const height = isImageOrLatex ? metrics.height + rowMargin * 2 : Math.max(lineHeight, contentHeight);
    ...
    if (lastRow && (lastElement == null ? void 0 : lastElement.marginBottom)) {
    ...
    for (let i = 0; i < rowList.length; i++) {
      ...
      for (let j = 0; j < curRow.elementList.length; j++) {
        ...
        if (element.underline) {
          ...
          const ulContentHeight = metrics.boundingBoxAscent + metrics.boundingBoxDescent;
          const ulLineMargin = Math.max(0, (ulLineHeight - ulContentHeight) / 2);
          this.underline.recordFillInfo(ctx, x, y + curRow.height - ulLineMargin, metrics.width, 0, element.color);
...
class Command {
  constructor(adapt) {
    ...
    __publicField(this, "executeTableTdBorderBgTop");
    __publicField(this, "executeTableTdBorderBgBottom");
    __publicField(this, "executeTableTdBorderBgLeft");
    __publicField(this, "executeTableTdBorderBgRight");
    __publicField(this, "executeTableTdBorderWidthTop");
    __publicField(this, "executeTableTdBorderWidthLeft");
    __publicField(this, "executeTableTdBorderWidthBottom");
    __publicField(this, "executeTableTdBorderWidthRight");
    ...
    this.executeTableTdBorderWidthLeft = adapt.tableTdBorderWidthLeft.bind(adapt);
    this.executeTableTdBorderWidthBottom = adapt.tableTdBorderWidthBottom.bind(adapt);
    this.executeTableTdBorderWidthRight = adapt.tableTdBorderWidthRight.bind(adapt);
...
function printImageBase64(base64List, width, height) {
  ...
  style2.append(document.createTextNode(stylesheet));
  setTimeout(() => {
    doc.write(`${style2.outerHTML}${container.innerHTML}`);
    contentWindow.print();
    doc.close();
...
class CommandAdapt {
  ...
  getEffectiveSize() {
    ...
    return (anchor == null ? void 0 : anchor.size) || defaultSize;
  }
  size(payload) {
  ...
  paragraphSpacing(before, after) {
    ...
    while (paraEnd < elementList.length - 1 && elementList[paraEnd + 1].value !== ZERO) {
      paraEnd++;
    }
  ...
  tableTdBorderWidthLeft(payload) {
    var _a, _b, _c;
    const isReadonly = this.draw.isReadonly();
    if (isReadonly)
      return;
  ...
  tableTdBorderWidthBottom(payload) {
    var _a, _b, _c;
    const isReadonly = this.draw.isReadonly();
    if (isReadonly)
      return;
  ...
  tableTdBorderWidthRight(payload) {
    var _a, _b, _c;
    const isReadonly = this.draw.isReadonly();
    if (isReadonly)
      return;
  ...
  editHyperlink(url) {
    ...
    new Dialog({
      ...
      onConfirm: (payload) => {
        ...
        if (!name)
          return;
        const url2 = (_b = payload.find((p) => p.name === "url")) == null ? void 0 : _b.value;
        if (!url2)
          return;
...
const globalMenus = [
  ...
  },
  {
    ...
    when: (payload) => {
      var _a;
      return !payload.isReadonly && payload.editorTextFocus && ((_a = payload.startElement) == null ? void 0 : _a.type) !== ElementType.HYPERLINK;
    },
    callback: (command) => {
...
const hyperlinkMenus = [
  ...
  },
  {
    ...
    callback: (command, context) => {
      var _a;
      const url = (_a = context.startElement) == null ? void 0 : _a.url;
      if (url) {
...
class ColorPicker {
  ...
  _render() {
    ...
    confirmBtn.type = "submit";
    confirmBtn.onclick = () => {
      const element = document.getElementById("td-bgcolor");
      if (onConfirm)
        onConfirm({ value: element.value });
      this._dispose();
    };
    menuContainer.append(confirmBtn);
...
__publicField(DOMEventHandlers, "instance");
class Editor {
...
export { BlockType, Command, ControlType, DOMEventHandlers, EDITOR_COMPONENT, Editor, EditorComponent, EditorMode, EditorZone, ElementType, ImageDisplay, KeyMap, ListStyle, ListType, MaxHeightRatio, NumberType, PageMode, PaperDirection, RowFlex, TableBorder, TitleLevel, VerticalAlign, WordBreak, Editor as default };
